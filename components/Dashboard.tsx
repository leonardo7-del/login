      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 bg-slate-800/50 border border-slate-700 rounded-2xl p-8">
            <h1 className="text-3xl font-bold mb-4">¡Bienvenido de nuevo, {user.fullName.split(' ')[0]}!</h1>
            ...
            <div className="flex gap-4">
              ...
              <button className="bg-slate-700 hover:bg-slate-600 text-white px-6 py-2.5 rounded-xl font-medium transition-colors">
                Ajustes
              </button>
            </div>
          </div>
          ...
          {/* Stats Card */}
          <div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-8 flex flex-col justify-center items-center text-center">
            ...
            <p className="text-sm text-slate-400">Tu cuenta está cifrada y segura en nuestra base de datos indexada local.</p>
          </div>
        </div>
          ...
          <div className="bg-slate-800/30 border border-slate-800 rounded-2xl overflow-hidden">
             <div className="p-6 border-b border-slate-800 flex items-center gap-4">
               ...
               <div>
                 ...
                 <p className="text-xs text-slate-500">Hoy a las {new Date().toLocaleTimeString()}</p>
               </div>
             </div>
             <div className="p-6 border-b border-slate-800 flex items-center gap-4">
               ...
               <div>
                 ...
                 <p className="text-xs text-slate-500">Fecha de creación: {new Date(user.createdAt).toLocaleDateString()}</p>
               </div>
             </div>
          </div>
        </section>
